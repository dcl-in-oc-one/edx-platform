     ...
     edx.dashboard.legacy.init = function(urls) {
        ...
        // Generate the properties object to be passed along with business intelligence events.
         ...
         function setDialogAttributes(isPaidCourse, certNameLong,
             ...
             if (isPaidCourse) {
                 if (showRefundOption) {
                     diagAttr['data-refund-info'] = 'You will be refunded the amount you paid.';
                 } else {
                     diagAttr['data-refund-info'] = 'You will not be refunded the amount you paid.';
                 }
                 diagAttr['data-track-info'] = 'Are you sure you want to unenroll from the purchased course ' +
                     courseName + ' (' + courseNumber + ')?';
             } else if (enrollmentMode !== 'verified') {
                 diagAttr['data-track-info'] = 'Are you sure you want to unenroll from ' +
                     courseName + ' (' + courseNumber + ')?';
             } else if (showRefundOption) {
                 diagAttr['data-track-info'] = 'Are you sure you want to unenroll from the verified ' +
                     certNameLong + ' track of ' + courseName + ' (' + courseNumber + ')?';
                 diagAttr['data-refund-info'] = 'You will be refunded the amount you paid.';
             } else {
                 diagAttr['data-track-info'] = 'Are you sure you want to unenroll from the verified ' +
                     certNameLong + ' track of ' + courseName + ' (' + courseNumber + ')?';
                 diagAttr['data-refund-info'] = 'The refund deadline for this course has passed,' +
         ...
         $('.action-unenroll').click(function(event) {
             ...
             request.success(function(data) {
                 if (data.success) {
                     ...
                     $('#unenroll_error').html(
                        gettext('Unable to get refund status for course, Try again later')
                     ).stop()
                      .css('display', 'block');
